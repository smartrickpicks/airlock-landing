...
const coreModules = [
  { iconSrc: '/brand/icons/mod-contracts.png', name: 'Contracts', desc: '188 clauses \u00b7 24 types \u00b7 5 verticals', sub: 'Generate, extract, and manage contracts with a pre-approved clause library and AI-powered extraction engine.', color: 'var(--chamber-discover)' },
  { iconSrc: '/brand/icons/mod-crm.png', name: 'CRM', desc: 'Vault-native pipeline \u00b7 Radar \u00b7 Ghost', sub: 'CRM is a lens over your vault hierarchy \u2014 accounts, subsidiaries, contacts, and deals in one data model.', color: 'var(--chamber-build)' },
